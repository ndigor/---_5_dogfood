...
function App() {
  ...
  <Route path="/src/pages/ProfilePage/ProfilePage.jsx" element={
      <Modal modalActive={modalActive} setModalActive={setModalActive} >
        <ProfilePage setIsRefetch={setIsRefetch} isRefetch={isRefetch}/>
      </Modal>
    } />
      ...
      <ThemeContext.Provider value={theme}>
        <CardsContext.Provider value={cardsValue}>
          <UserContext.Provider value={user}>
            <Header setSearch={setSearch} favorites={favorites}  isRefetch={isRefetch}>
            </Header>
            <main className="container content ">
              {isAuthorized ?
                <Routes>
                  ...
                  <Route path="/profile" element={<ProfilePage setIsRefetch={setIsRefetch} isRefetch={isRefetch}/>} />
                  {authRoutes}
                  <Route path="/stylebook" element={<AntdPage />} />
                  <Route path="*" element={<div>NOT FOUND 404</div>} />
                  <Route path="./pages/ProfilePage/ProfilePage.jsx" element={< ProfilePage setIsRefetch={setIsRefetch} isRefetch={isRefetch}/>} />
                </Routes>
                :
